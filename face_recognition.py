...
class Face_Recognition:
    def __init__(self,root):
        ...
        b1_1=Button(f_lbl,text="Face Recognition",cursor="hand2",font=("times new raoman",18,"bold"),fg="white",bg="darkgreen",command=self.face_recog)
        b1_1.place(x=330,y=630,width=295,height=40)
    #=================Attendence==================
    def mark_attendence(self,i,r,n,d):
        with open(r"Attendence_report\Present.csv","r+",newline="\n") as f:
            myDatalist=f.readlines()
            name_list=[]
            for line in myDatalist:
                entry=line.split((","))     # Kiran , 2 , computer save the in this form
